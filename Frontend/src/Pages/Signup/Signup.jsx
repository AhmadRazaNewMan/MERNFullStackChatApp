    ...
    backdrop-filter backdrop-blur-lg bg-opacity-0 border">
        ...
        <form action="">
            <div >
                ...
                <input type="text" placeholder="John Doe " className="w-full input input-borderd h-10"  id="username"/>
            </div>
            <div >
                <label htmlFor="username" className="label p-2">
                    <span className="text-base  text-gray-300 label-text">User Name</span>
                </label>
                <input type="text" placeholder="johndoe@ " className="w-full input input-borderd h-10"  id="username"/>
            </div>
            <div >              
                <label htmlFor="username" className="label p-2">
            ...
            <div >              
                ...
                <input type="passwors" placeholder="Confirm Your password here.... " className="w-full input input-borderd h-10"  id="username"/>
            </div>
